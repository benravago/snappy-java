 ...
 *
 * Adapted from http://web.mit.edu/freebsd/head/sys/libkern/crc32.c
 */
@bsd.LICENSE 
public final class Crc32c {

    /**
     * Mask a checksum; checksumming data and then its own checksum can be problematic.
     *
     * The masking is the same as used in Apache Hadoop:
     * Rotate the checksum by 15 bits, then add the constant 0xa282ead8
     * (using wraparound as normal for unsigned integers).
     *
    ...
    /**
     * Compute a crc32-c checksum for the specified array of bytes.
     *
     * @param b - the data
    ...
    /**
     * Compute a crc32-c checksum for the specified array of bytes using a given 'seed' value.
     *
     * @param crc - the initial checksum value
     * @param b - the data
     * @param off - the start offset in the data
     * @param len - the number of bytes to checksum
     * @return the current checksum value
